<div class="p-16 bg-white border rounded-lg flex flex-col items-center justify-center text-center">
  ...
  <div class="mt-8 text-gray-600">{{ $text ?? 'You haven\'t created any concerts!' }}</div>

  @if (!isset($hideCreateButton))
    <div class="mt-8">
      <a href="{{ route('backstage.concerts.create') }}" class="inline-block btn text-sm">Create a concert</a>
    </div>
  @endif
</div>
