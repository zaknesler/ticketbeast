    ...
    <div class="p-6 m-auto max-w-xs w-full">
      ...
      <form action="#" method="POST" class="mt-6">
        ...
        <div class="mt-6 text-sm flex items-center justify-between">
          <div>
            Have an account? <a tabindex="5" href="{{ route('auth.login') }}" class="font-semibold text-gray-700 hover:text-gray-800 hover:underline">Sign in</a>
          </div>

          <button tabindex="4" class="btn px-5 py-2">Sign up</button>
        </div>
      </form>
    </div>
  </div>
