<div class="sm:p-8 m-auto max-w-xl w-full h-full min-h-full sm:flex sm:items-center sm:justify-center">
  <div class="p-8 w-full h-full sm:h-auto bg-white sm:border sm:rounded-lg flex flex-col">
    <div class="flex-1">
